...
class Mouth:
    def __init__(self, led: PWMLED, output_rate: int = 24000, max_volume: float = 5000):
        """
    ...
    def map_volume_to_brightness(self, rms: float) -> float:
        """
        Map the computed RMS value to a brightness value between 0.0 and 1.0.
        Adjust max_volume based on your experimental audio levels.
        """
        brightness = rms / self.max_volume
